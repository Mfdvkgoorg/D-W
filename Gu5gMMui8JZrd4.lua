-- ป้องกันการโหลด UI ซ้ำซ้อน (ป้องกัน stack overflow ถ้าโหลดซ้ำ)
if getgenv and getgenv().TB_UI_GETKEY_LOADED then return end
if getgenv then getgenv().TB_UI_GETKEY_LOADED = true end
